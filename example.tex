...
\participants{\begin{itemize}\item[{$\boxtimes$}] John Doe\item[{$\boxtimes$}] Kim Miller \begin{itemize}\item online\end{itemize}\item[{$\boxtimes$}] Susan Parker\item[{$\square$}] Peter Smith\item[{$\boxtimes$}] Alexandra West\end{itemize}}
\author{John Doe}
