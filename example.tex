...
\end{itemize}
\item \NoteTag{}{::}This is a visible note. Outside the protocol or added later (with timestamp). \Comment{But this an invisible comment.}
\end{itemize}
\end{document}